...
class ModelMock(object):
    ...
    def get_map_center(self):
        ...
        map_center = SkyCoord(ramap_center*u.deg, decmap_center*u.deg, frame='icrs') # Compute offsets wrt center
    ...
    def get_pressure_profile(self, radius=np.logspace(0,4,100)*u.kpc):
        """
    ...
    def get_pressure_fluctuation_spectrum(self, kvec=np.logspace(-1,2,100)*u.Mpc**-1):
        """
    ...
    def pressure_cube_profile(self):
        """
    ...
    def pressure_cube_fluctuation(self, seed=None,
                                  kmin_input=None, kmax_input=None,
                                  force_isotropy=False, Npt=1000):
        """
    ...
    def get_sz_map(self, seed=None, no_fluctuations=False, force_isotropy=False):
        """
        ...
        #----- Get P(r) grid
        pressure_profile_cube = self.pressure_cube_profile()

        #----- Get delta P(x,y,z) grid
        if no_fluctuations:
            pressure_fluctuation_cube = pressure_profile_cube.value*0
        else:
            pressure_fluctuation_cube = self.pressure_cube_fluctuation(seed=seed, force_isotropy=force_isotropy)
